...
BEGIN_MESSAGE_MAP(CRayTracerApp, CWinAppEx)
...
// CRayTracerApp 自定义加载/保存方法

void CRayTracerApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CRayTracerApp::LoadCustomState()
{
}

void CRayTracerApp::SaveCustomState()
{
}
